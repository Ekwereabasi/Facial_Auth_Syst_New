    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                print(f"Error during facial authentication: {ex}")  # Log the error for debugging
    else:
...
def facial_login_test(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                form.add_error(None, str(e))
                print(f"ValidationError: {e}")  # Debugging line
            except Exception as ex:
                form.add_error(None, f"An unexpected error occurred: {ex}")
                print(f"Exception: {ex}")  # Debugging line
    ...
    return render(request, 'banking/facial_login_test.html', {
        'form': form,
        'message': message,
    })
